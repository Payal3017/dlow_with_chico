...
# from motion_pred.utils.dataset_chico import DatasetChico
from chico.utils_chico.PoseDataset import PoseDatasetDlow as DatasetChico
...
if __name__ == '__main__':
    ...
    """data"""
    dataset_cls = DatasetH36M if cfg.dataset == 'h36m' else DatasetHumanEva if cfg.dataset == 'humaneva' else DatasetChico
    dataset = dataset_cls('train', t_his=t_his, t_pred=t_pred, actions='all', use_vel=cfg.use_vel,dataset=cfg.dataset)
